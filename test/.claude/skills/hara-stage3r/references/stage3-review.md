...
```json
{
  "meta": {
    ...
    "stage": "stage3_review",
    "mf_id": "<MF_ID>",
    "target_file": "output/<run_id>_stage3_<MF_ID>_hara.json",
    "generated_at": "ISO时间戳"
  },
  ...
  "per_scenario_reviews": [
    {
      ...
      "MF_ID": "<MF_ID>",
      "result": "pass",
      "scenario_reality": "pass - <真实性结论>",
      "scenario_independence": "pass - <独立性结论>",
      "internal_consistency": "pass - <内部一致性结论>",
      "operational_domain_consistency": "pass - <运行域一致性结论>",
      "max_asil_search_coverage": "pass - <最大ASIL覆盖结论>",
      "motion_logic": "pass - <运动逻辑结论>",
      "hazard_event_logic": "pass - <危害事件逻辑结论>",
      "sec_reasoning": "pass - <S/E/C推理结论>",
      "safety_goal_consistency": "pass - <安全目标/安全状态结论>",
      "issues": [],
      "fixes": [],
      "notes": "评审说明"
    }
